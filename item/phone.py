...
INFO_BOX = f"""
{PURPLE}╔══════════════════════════════════════════════════════════════╗{RESET}
{PURPLE}║{RESET}{WHITE}{BOLD}              PHONE NUMBER OSINT TOOLS v1.1.0                 {RESET}{PURPLE}║{RESET}
{PURPLE}╠══════════════════════════════════════════════════════════════╣{RESET}
{PURPLE}║{RESET}  {BOLD}Author{RESET}   : Ruyynn && d3nz                                   {PURPLE}║{RESET}
{PURPLE}║{RESET}  {BOLD}GitHub{RESET}   : github.com/denzklian                             {PURPLE}║{RESET}
{PURPLE}║{RESET}  {BOLD}Version{RESET}  : 1.1.0                                            {PURPLE}║{RESET}
{PURPLE}║{RESET}  {BOLD}Updated{RESET}  : 2026-26-jun                                      {PURPLE}║{RESET}
{PURPLE}╚══════════════════════════════════════════════════════════════╝{RESET}"""
...
║  • Author   : Ruyynn                                               ║
║  • GitHub   : https://github.com/denzklian                         ║
║  • Support  : dana : 085389400823                                  ║
║  • Email    : denzkucai@gmail.com                                  ║
║  • Kolaborasi? : chat admin aja                                    ║
╠════════════════════════════════════════════════════════════════════╣
║  {GREEN}📚 VERSION HISTORY{RESET}{WHITE}                                                ║
║  • v1.0.0 (2026-02-15) - Rilis awal                                ║
║  • v1.1.0 (2026-jun-24) - optimal - feature improvement            ║
╚════════════════════════════════════════════════════════════════════╝{RESET}
"""
    ...
    def menu_main(self):
        while True:
            ...
            if choice == '0':
                print(f"\n{GREEN}Terima kasih telah menggunakan GHOST-CRACK!{RESET}")
                print(f"{BLUE}report bug: t.me/denzkucai{RESET}")
                break
            elif choice == '1':
                self.menu_analyze()
            elif choice == '2':
...
def phone():
    try:
        print(f"{BLUE}{BOLD}Loading...{RESET}")
        time.sleep(1)
